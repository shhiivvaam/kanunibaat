  ...
  return (
    <section className="rounded-2xl border border-[#E7E5E4] bg-white shadow-sm">
      <div className="border-b border-[#E7E5E4] px-5 py-4">
        <h2 className="text-sm font-semibold text-[#1C1917]" style={{ fontFamily: 'var(--font-display)' }}>
          Chat
        </h2>
        <p className="mt-1 text-xs text-[#78716C]" style={{ fontFamily: 'var(--font-body)' }}>
          Messages refresh every few seconds.
        </p>
      </div>
        ...
        {list.isPending ? (
          ...
          messages.map((m) => (
            <div key={m.id} className="rounded-xl bg-[#FAFAF9] p-3 ring-1 ring-[#E7E5E4]">
              <p className="whitespace-pre-wrap text-sm text-[#1C1917]" style={{ fontFamily: 'var(--font-body)' }}>
                {m.body}
              </p>
              <p className="mt-1 text-[11px] text-[#A8A29E]" style={{ fontFamily: 'var(--font-body)' }}>
