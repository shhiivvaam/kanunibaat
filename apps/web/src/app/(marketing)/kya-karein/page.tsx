    ...
    <div className="mx-auto max-w-[960px] px-6 py-16">
      <header className="mb-10">
        ...
        <p className="mt-3 max-w-2xl text-sm leading-relaxed text-[#57534E]" style={{ fontFamily: 'var(--font-body)' }}>
          Choose a situation for general guidance on immediate steps, documents, and when to involve police or courts.
          This is not a substitute for calling emergency services or speaking to a lawyer about your specific case.
        </p>
      </header>
      <EmergencyGuideHome />
    </div>
