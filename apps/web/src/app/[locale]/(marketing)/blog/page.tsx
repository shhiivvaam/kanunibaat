...
export const metadata: Metadata = {
  title: 'Blog',
  description:
    'Updates, explainers, and product notes from Jurisly — legal help for India in plain language.',
  openGraph: {
    title: 'Blog | Jurisly',
    description: 'Updates and explainers from the Jurisly team.',
  },
};
  ...
  return (
    <div className="min-h-screen bg-[#FAFAF9] px-6 py-16">
      <div className="mx-auto max-w-[720px]">
        ...
        <p
          className="mb-12 text-lg text-[#57534E]"
          ...
          {posts.map((post) => (
            <li key={post.slug}>
              <article className="rounded-[20px] border border-[#E7E5E4] bg-white p-6 transition-shadow hover:shadow-md">
                ...
                <h2
                  className="mt-2 text-xl font-bold text-[#1C1917]"
                  style={{ fontFamily: 'var(--font-display)' }}
                >
                ...
                {post.author ? (
                  <p
                    className="mt-3 text-xs text-[#78716C]"
