...
**Goal (from [KanuniBaat.md](../KanuniBaat.md) §6 Phase 4):** Ship the viral notice-scanner flow with upload, OCR/AI analysis pipeline, and user-facing result surfaces.
...
1. Apply migration set through current head (`pnpm --filter @kb/database db:migrate`).
