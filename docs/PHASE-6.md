...
**Goal (from [KanuniBaat.md](../KanuniBaat.md) §6 Phase 6):** Deliver scenario-driven legal emergency guidance with a safe fallback path when AI is unavailable.
...
| Safety text | Legal information disclaimer attached to responses | Done | `LEGAL_INFO_DISCLAIMER` in `@kb/emergency-guide` usage |
